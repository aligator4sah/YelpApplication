...
public class YelpApi {
  ...
  private static final String CLIENT_ID = "IHYQPKH4c5tErFUN1QMWYg";
  private static final String CLIENT_SECRET = "uZ9u8zQfCPJtSFk71Hgmh5IXISnGsK9clgXCIMzVxXRrnwLG2nfzHgUomgmtzD1C";
 ...
 private String urlEncodeHelper(String term) {
  ...
  private void queryAPI(double lat, double lon) {
    /*JSONArray restaurants = search(lat, lon, null);
    try {
